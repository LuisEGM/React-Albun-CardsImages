...
const CardPrincipal = ({ linkImg , title, descripcion }) => (
    ...
    <div className="card ancho">
        <img className="card-img-top" src={linkImg || "https://images.pexels.com/photos/36717/amazing-animal-beautiful-beautifull.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500" }  alt="Card image cap" alt="Card image cap"/>
